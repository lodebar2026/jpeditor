...
import { loadCli, loadCorpus } from "./node-harness.mjs";
import { openDb, loadGlyphFixes, replaceTable, newRunId, recordRun, recordDiffs } from "./checkdb.mjs";
...
const { gtKeyTime } = await import("./node-harness.mjs");
const mismatches = [];
